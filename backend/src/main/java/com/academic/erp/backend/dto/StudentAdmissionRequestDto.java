...
@AllArgsConstructor
@Builder
@Schema(description = "Request DTO for admitting a new student")
public class StudentAdmissionRequestDto {
    ...
    @Schema(description = "ID of the domain to which the student will be admitted", example = "1", requiredMode = Schema.RequiredMode.REQUIRED)
    @NotNull(message = "Domain ID is required")
    private Long domainId;

    @Schema(description = "Year when the student joins", example = "2024", requiredMode = Schema.RequiredMode.REQUIRED)
